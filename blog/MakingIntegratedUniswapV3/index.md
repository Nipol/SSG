...
![유니스왑 V3를 이용하여, `500,000,000 Dai`를 USDC로 교환할 때 수수료와 0.1%의 슬리피지 영향](./screenshot1.webp)

![Curve finance를 이용하여, `500,000,000 Dai`를 USDC로 교환할 때 수수료와 0.3%의 슬리피지 영향](./screenshot2.webp)
...
![유니스왑 V3 Dai/USDC Pool, 거의 1:1에 가까운 비율로만 유동성이 집중된 모습](./screenshot3.webp)
...
![유니스왑의 유동성 분포 예시, 각 지축의 양 끝에는 무제한에 해당하는 가격으로 처리하며, 가격의 분포에 따라 유동성이 집중된 모습을 보여줌](./screenshot4.webp)
...
![가격 공간과, 제곱근 된 가격 공간을 비교했을때 일치하는 모습](./screenshot5.webp)
...
![가격 공간에서, 현재의 가격 지점과, 유동성을 등록하려는 가격의 범위](./screenshot6.webp)
...
![가격 공간과 Tick 공간이 일치하는 모습](./screenshot7.webp)
...
![Tick 공간에서, 하나의 가격 지점이 가지고 있는 Tick의 단위](./screenshot8.webp)
...
![1. 가격 공간에서, 현재 가격과 가격대에 등록된 유동성](./screenshot9.webp)
...
![2. 예시로 등록된, “진한 파랑색으로 표시된 1,600 DAI에 ETH를 판매하는 유동성 주문”과 “진한 주황색으로 표시된 900 DAI에 ETH를 구매하는 유동성 주문”](./screenshot10.webp)

![3. 이후 ETH 가격이 상승하여, ETH를 1,600 DAI에 판매하는 유동성 전부가 DAI로 변환됨](./screenshot11.webp)

![4. 또 다른 경우로, ETH의 가격이 하락하여 900 DAI에 ETH를 구매하는 유동성이 전부 ETH로 변환됨](./screenshot11.webp)
...
![유니스왑 인터페이스에서 쌓인 수수료](./screenshot14.webp)
...
![Periphery 컨트랙트가 중개하는 Core 컨트랙트 개요도](./screenshot15.webp)
...
![실제 유니스왑 코드를 통합할 때 생기는 오류들](./screenshot17.webp)
